...
const BikeList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: ({ row: { isAvailable } }) => {
        return <Checkbox checked={isAvailable} value={isAvailable} />;
      },
    },
    {
      field: "actions",
      ...
      renderCell: (params) => {
        return (
          <>
            <Button sx={{ color: colors.greenAccent[700] }}>Edit</Button>
  ...
  return (
    <Grid m="20px" width="100%" sx={{ m: 2, p: 2 }}>
      <Header title="Bikes" subtitle="List of Bikes for Future Reference" />
      <Grid
        m="40px 0 0 0"
        height="75vh"
        sx={{
